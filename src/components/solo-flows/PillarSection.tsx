    ...
    <motion.section className="py-20" style={{ borderTop: '1px solid var(--card-border)' }}
      ...
      <div className="max-w-5xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-start">
        <div>
          ...
          {pillar.images?.[0] && (
            <div className="mt-6 overflow-hidden rounded-xl" style={{ border: '1px solid var(--card-border)' }}>
              <Image
                src={pillar.images[0]}
                alt={lang === 'vi' ? pillar.titleVi : pillar.title}
                width={800}
                height={500}
        ...
        <div className="space-y-6">
          ...
          {(lang === 'vi' ? pillar.metricsVi : pillar.metrics).length > 0 && (
