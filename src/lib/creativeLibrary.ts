...
export const UGC_VIDEOS: CreativeItem[] = [
  {
    id: 'ugc-comfave-footdrop-before-after',
    type: 'video',
    src: 'https://kwrnssd2wlpgmi3q.public.blob.vercel-storage.com/creative/comfave-footdrop-before-after.mp4',
    poster: '/images/creative/comfave-footdrop-before-after-poster.jpg',
    caption: 'Comfave foot drop bracing before/after UGC-style demo.',
    captionVi: 'Clip UGC before/after nẹp hỗ trợ bàn chân rủ (foot drop) Comfave.',
    model: 'Omni',
    duration: '0:30',
    language: 'en',
    rating: 5,
    brand: 'Comfave',
    title: 'Comfave foot drop bracing before/after',
    titleVi: 'Comfave nẹp foot drop — before/after',
  },
  {
    id: 'ugc-comfave-footdrop-social-proof',
    type: 'video',
    src: 'https://kwrnssd2wlpgmi3q.public.blob.vercel-storage.com/creative/comfave-footdrop-social-proof.mp4',
    poster: '/images/creative/comfave-footdrop-social-proof-poster.jpg',
    caption: 'Comfave foot drop bracing social-proof UGC concept clip.',
    captionVi: 'Clip UGC social-proof nẹp hỗ trợ bàn chân rủ (foot drop) Comfave.',
    model: 'Omni',
    duration: '0:30',
    language: 'en',
    rating: 5,
    brand: 'Comfave',
    title: 'Comfave foot drop bracing social proof',
    titleVi: 'Comfave nẹp foot drop — social proof',
  },
  {
    id: 'ugc-gucci-dress',
    type: 'video',
