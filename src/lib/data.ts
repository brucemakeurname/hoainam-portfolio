...
export const SOLOFLOWS_PILLARS = [
  {
    ...
    what: 'soloflows.com is the AI Marketing Agency ecosystem, built around three integrated products: Desk, a chat-first content subscription that plans, creates, and delivers marketing content on a recurring schedule; B.A.I, direct booking of the 4 AI Influencers for sponsored content; and Newsfeed, an always-on stream of AI marketing content. No human ops needed to run any of it.',
    whatVi: 'soloflows.com là hệ sinh thái AI Marketing Agency, xây dựng quanh 3 sản phẩm tích hợp: Desk, dịch vụ content dạng subscription chat-first lên kế hoạch, sản xuất và giao nội dung marketing định kỳ; B.A.I, đặt lịch trực tiếp với 4 AI Influencer cho nội dung tài trợ; và Newsfeed, dòng nội dung liên tục về AI marketing. Không cần nhân sự vận hành cho bất kỳ phần nào.',
